    ...
    return (
        <div className="min-h-screen bg-[#F5F5F7] text-[#1D1D1F] font-sans selection:bg-blue-200">
            ...
            <div className="bg-[#DA552F] text-white px-4 py-3 text-center text-sm md:text-base font-medium flex justify-center items-center">
                ...
                <a href="https://www.producthunt.com/" target="_blank" rel="noopener noreferrer" className="ml-2 underline font-bold hover:text-white/80 transition">
                    Check it out
                </a>
            </div>
            ...
            <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto flex flex-col items-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="https://www.producthunt.com/" target="_blank" rel="noopener noreferrer" className="hover:scale-105 transition-transform flex items-center justify-center opacity-95 hover:opacity-100 cursor-pointer h-[60px] sm:h-[66px]">
                        <img src="/packwork/product-hunt-logo-horizontal-orange.png" alt="Project on Product Hunt" className="h-full w-auto block select-none pointer-events-none drop-shadow-sm" draggable={false} />
                    </a>
                </div>
                    ...
                    <div className="bg-black text-white rounded-[40px] p-10 md:p-16 shadow-2xl overflow-hidden relative">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center space-x-3 mb-6">
                                <div className="bg-yellow-400 text-black text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest">Premium</div>
